  ...
  return (
    <div className="livro-card">
      {livro.capa ? (
        ...
        <div className="livro-capa-placeholder" style={{ height: '200px', background: '#ddd', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '10px', borderRadius: '4px' }}>
          <span>Sem Capa</span>
        </div>
      )}
      ...
      <div style={{ marginTop: '10px', borderTop: '1px solid #eee', paddingTop: '10px' }}>
        <button className="btn btn-secondary" style={{ width: '100%', fontSize: '0.8rem' }} onClick={() => alert('Funcionalidade de ver reviews seria aberta aqui (Modal)')}>
          ⭐ Ver Avaliações
        </button>
      </div>
    </div>
